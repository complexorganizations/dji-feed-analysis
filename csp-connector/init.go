...
func init() {
	...
	// Real time staus of the rtsp server via channel
	...
	go checkRTSPServerAliveInBackground(TestJSONValue.(*AutoGenerated).Num0.Host, rtspServerStatusChannel, &rtspServerWaitGroup)
